...
public class addquestion extends AppCompatActivity {
    ...
    {
        editText8.animate().alpha(1);
        editText9.animate().alpha(1);
        editText10.animate().alpha(1);
        editText12.animate().alpha(1);
        editText13.animate().alpha(1);
        editText14.animate().alpha(1);
        button7.animate().alpha(1);
